        ...
        <main>
            ...
            <div>
                ...
                if (isset($_POST["submit"])) {
                    if ($demographicInformation->applicantDemographicInfoExists($applicantId)) {
                        if ($demographicInformation->updateDemographicInformation()) {
                        ...
                        $demographicInformation = new Applicant($table, $columns, $parameters);
                        if ($demographicInformation->save()) {
                            echo "Saved successifuly";
                            refresh($_SERVER['PHP_SELF'], 3);
                        } else {
                            echo "Saving failure";
