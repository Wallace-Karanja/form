                ...
                <div>
                    ...
                    <form action="" method="post" id="form">
                        ...
                        <div>
                            ...
                            <input type="text" name="second_name" id="secondName"
                                value="<?php echo (isset($row['second_name']) ? $row['second_name'] : ''); ?>" />
                        </div>
                        <div>
                        ...
                        <div>
                            <label for="alternativePhoneNumber">Alternative Phone<span
