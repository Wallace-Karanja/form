                    ...
                    <?php foreach ($info as $row) { ?>
                        <div>
                            ...
                            <div class="info-container">
                                <div>
                                    <p><b>Term</b>:<?php echo $row['intake']; ?></p>
                                </div>
                                <?php if (!empty($row['admission_number'])) { ?>
                                    <p><b>Admission number</b> : <?php echo $row['admission_number']; ?></p>
                                <?php } ?>
                            </div>
                            <div>
                            ...
                            <div class="info-container">
                                <div>
                                    <p><b>Name</b> :
                                        <?php echo $row['firstname'] . " " . $row['second_name'] . " " . $row['lastname']; ?></p>
                                </div>
                                <div>
        ...
        <div>
            ...
            <form action="" method="post" id="form">
                ...
                <?php
                    ...
                    <div><input type="submit" name="submit" value="Submit Application" class="submit" style="background-color: green; font-weight: bold;"></div>
                <?php } ?>
                <?php
                    if ($application->applicationIsSubmitted()) { ?>
                    <div><input type="submit" name="retract" value="Withdraw Application" class="submit" style="background-color: red; color:black; font-weight: bold;"></div>
                <?php }
                ?>
