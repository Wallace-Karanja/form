        ...
        <div style="background-color: wheat; padding: 10px;">
            ...
            ?>
                ...
                <form action="" method="post" id="form">
                    ...
                    <div>
                        <input type="date" name="start_date" id="start_date" value="<?php echo $intake['start_date'] ?? null; ?>" required>
                    </div>
                    <div>
                        <label for="end_date">End date</label>
                    </div>
                    <div>
                        <input type="date" name="end_date" id="start_date" value="<?php echo $intake['end_date'] ?? null; ?>" required>
                    </div>
                    <div>
                        <label for="intake">Intake</label>
                    </div>
                    <div>
                        <input type="text" name="intake" id="" placeholder="e.g. SEPTEMBER 2024" value="<?php echo $intake['intake'] ?? null; ?>" required>
                    </div>
                    <div>
            ...
            <?php } else { ?>
                ...
                <form action="" method="post" id="form">
                    ...
                    <div>
                        <input type="date" name="start_date" id="start_date" value="<?php echo $_POST['start_date'] ?? null; ?>" required>
                    </div>
                    <div>
                        <label for="end_date">End date</label>
                    </div>
                    <div>
                        <input type="date" name="end_date" id="start_date" value="<?php echo $_POST['end_date'] ?? null; ?>" required>
                    </div>
                    <div>
                        <label for="intake">Intake</label>
                    </div>
                    <div>
                        <input type="text" name="intake" id="" placeholder="e.g. SEPTEMBER 2024" value="<?php echo $_POST['intake'] ?? null; ?>" required>
                    </div>
                    <div>
                        <label for="active">Active</label>
                    </div>
