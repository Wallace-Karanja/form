        ...
        <div>
            ...
            <?php if ($application->applicationDecisionExist()) { ?>
                <form action="" method="post" id="form">
                    ...
                    <?php if (!$admitted) { ?>
                        <div><input type="submit" name="admit" value="Admit" class="submit" style="background-color: green;"></div>
                    <?php } ?>
                    <?php if ($admitted) { ?>
                        <div><input type="submit" name="decline" value="Decline" class="submit" style="background-color: red;"></div>
                    <?php } ?>
                </form>
            <?php } else { ?>
                <style>
